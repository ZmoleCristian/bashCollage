...
if [ -f /usr/bin/apt-get ]; then
  ...
  PM="yum"
  PM_INSTALL="install"
  PM_PACKAGES="gcc php-devel php-pear ImageMagick ImageMagick-devel ImageMagick-perl sed"
  PM_YES="-y"
elif [ -f /usr/bin/pacman ]; then
  PM="pacman"
  PM_INSTALL="-S"
  PM_PACKAGES="libltdl  lcms2  fontconfig  libxext  liblqr  libraqm libpng  libxml2 imagemagick sed"
